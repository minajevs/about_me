...
export type SiteDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };

export type PersonalQueryVariables = Exact<{ [key: string]: never; }>;


export type PersonalQuery = { mdx?: Maybe<(
    Pick<Mdx, 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'avatarUrl' | 'avatarAlt' | 'title'>> }
  )> };

export type SocialQueryVariables = Exact<{ [key: string]: never; }>;
...
export type OpensourcePageQueryVariables = Exact<{ [key: string]: never; }>;


export type OpensourcePageQuery = { allMdx: { nodes: Array<EntryFragment> } };
